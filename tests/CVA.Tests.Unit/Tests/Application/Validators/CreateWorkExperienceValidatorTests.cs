...
/// <summary>
/// Unit tests for the <see cref="CreateWorkExperienceValidator"/> class.
/// </summary>
[Trait(Layer.Application, Category.Validators)]
public class CreateWorkExperienceValidatorTests
{
    private readonly CreateWorkExperienceValidator _validator = new();
    ...
    public void Company_Validation(object input, bool shouldHaveError, CreateWorkExperienceCommand baseCommand)
    {
        // Arrange
        ...
        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with { Company = company });
    ...
    [InlineCvaAutoData(201, true)]
    public void Role_Validation(object input, bool shouldHaveError, CreateWorkExperienceCommand baseCommand)
    {
        // Arrange
        ...
        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with { Role = role });
    ...
    public void Description_Validation(object? input, bool shouldHaveError, CreateWorkExperienceCommand baseCommand)
    {
        ...
        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with { Description = description });
    ...
    /// </summary>
    [Theory, CvaAutoData]
    public void StartDate_NotEmpty_Validation(CreateWorkExperienceCommand baseCommand)
    {
        // Arrange
        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with { StartDate = null });
    ...
    /// </summary>
    [Theory, CvaAutoData]
    public void EndDate_Range_Validation(CreateWorkExperienceCommand baseCommand)
    {
        // Arrange
        var startDate = new DateOnly(2020, 1, 1);
        var endDate = new DateOnly(2019, 1, 1);

        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with { StartDate = startDate, EndDate = endDate });
    ...
    /// </summary>
    [Theory, CvaAutoData]
    public void Location_Should_Be_Validated(CreateWorkExperienceCommand baseCommand)
    {
        // Arrange
        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with
        {
    ...
    /// </summary>
    [Theory, CvaAutoData]
    public void TechStack_NotNull_Validation(CreateWorkExperienceCommand baseCommand)
    {
        // Arrange
        var command = new CreateWorkExperienceCommand(Request: baseCommand.Request with { TechStack = null! });
